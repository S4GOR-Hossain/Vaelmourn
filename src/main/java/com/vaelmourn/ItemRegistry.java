...
public final class ItemRegistry {
    ...
    public static void registerDefaults() {
        // Weapons
        add(new Item("iron_sword", "Iron Sword", Item.Category.WEAPON, new ColorRGBA(0.7f, 0.7f, 0.75f, 1f), 1, 40, "Models/Weapons/Melee/Sword.glb"));
        add(new Item("dagger", "Dagger", Item.Category.WEAPON, new ColorRGBA(0.6f, 0.6f, 0.65f, 1f), 1, 20, null));
        add(new Item("longbow", "Longbow", Item.Category.WEAPON, new ColorRGBA(0.55f, 0.4f, 0.25f, 1f), 1, 35, null));
        add(new Item("pistol", "Pistol", Item.Category.WEAPON, new ColorRGBA(0.2f, 0.2f, 0.25f, 1f), 1, 30, null));

        // Potions
        add(new Item("health_potion", "Health Potion", Item.Category.POTION, new ColorRGBA(0.9f, 0.2f, 0.2f, 1f), 10, 8, null));
        add(new Item("mana_potion", "Mana Potion", Item.Category.POTION, new ColorRGBA(0.2f, 0.4f, 0.9f, 1f), 10, 8, null));

        // Keys
        add(new Item("dungeon_key", "Dungeon Key", Item.Category.KEY, new ColorRGBA(0.9f, 0.8f, 0.2f, 1f), 5, 15, null));
        ...
        add(new Item("iron_ingot", "Iron Ingot", Item.Category.MATERIAL, new ColorRGBA(0.6f, 0.65f, 0.7f, 1f), 99, 3, null));
        add(new Item("leather", "Leather", Item.Category.MATERIAL, new ColorRGBA(0.55f, 0.4f, 0.3f, 1f), 99, 2, null));
